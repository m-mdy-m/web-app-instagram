...
template.innerHTML = `
    ...
    <div class=" w-[75%]  h-96 relative my-4  mx-auto ">
						...
						<div class=" w-full h-5/6 relative ">
							<img src="images/image/Post.jpg" alt="" class="w-full h-full object-cover rounded-b-xl">
...
class postBox extends HTMLElement {
	...
	connectedCallback() {
		this.shadowRoot.querySelectora()
	}
