...
template.innerHTML = `
	...
	<figure class="lg:h-full lg:w-full sm:w-8 sm:h-8 flex flex-col justify-between items-center ">
		<img src="images/image/image_story.jpg" alt="" class="lg:w-16 lg:h-16 rounded-full sm:w-8 sm:h-8 storyLine object-cover object-bottom cursor-pointer mt-2 hover:scale-[1.2] transition-all duration-1000">
	</figure>
